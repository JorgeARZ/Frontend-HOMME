  ...
  return (
    ...
    <div className="col-start-1 col-end-2 flex items-center">
        ...
        <p className="text-red-900 font-bold capitalize lg:mr-3 mr-3 lg:text-xl">bienvenido <strong>{name}</strong></p>
          ...
          <Link to='/Mdp' className='font-medium  py-2  sm:px-8 border border-red-900 text-red-900 bg-white outline-none rounded-l-full rounded-r-full hover:bg-red-900 hover:text-white  capitalize text-xl mr-2 '>MDP</Link>
          <Link to='/Index' className='font-medium  py-2 sm:px-8 border border-red-900 text-red-900 bg-white outline-none rounded-l-full rounded-r-full hover:bg-red-900 hover:text-white  capitalize text-xl mr-2 '>MHD</Link>
